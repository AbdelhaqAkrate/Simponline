...
<div>
    ...
    <div class="absolute p-4 top-0 left-0 right-0 bottom-0 mt-28 text-white font-bold" style="text-align: center; font-size: 48px">
      <div class="container mx-auto p-4 border border-indigo-600 flex justify-start content-center items-center">
        ...
        <div class="container mx-auto p-4 border border-red-600 ">
            <div class="p-2 ">
